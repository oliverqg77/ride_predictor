...
def validate_raw_data(
    ...
    """
    Removes rows with pickup_datatimes outside their valid range
    """
...
def get_cutoff_indices(
    ...
    #start the first sub-sequence ata index position 0
    subseq_first_idx = 0
...
def transform_ts_data_into_features_and_target(
    ...
    format that we can use to train Supervided ML models
    """
    ...
    for location_id in tqdm(location_ids):
        ...
        #numpy -> pandas
        target_one_location = pd.DataFrame(y, columns=[f'target_rides_next_hour'])
